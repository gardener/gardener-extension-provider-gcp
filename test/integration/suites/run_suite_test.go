...
import (
	...
	_ "github.com/gardener/gardener-extension-provider-gcp/test/integration/healthcheck"
...
func TestGardenerSuite(t *testing.T) {
	RunSpecsWithDefaultAndCustomReporters(t, "Provider-gcp Test Suite", []Reporter{reporter.NewGardenerESReporter(*reportFilePath, *esIndex)})
}

...
import (
	...
	configloader "github.com/gardener/gardener-extension-provider-gcp/pkg/apis/config/loader"
)
...
func (c *Config) ApplyHealthCheckConfig(config *configv1alpha1.HealthCheckConfig) {

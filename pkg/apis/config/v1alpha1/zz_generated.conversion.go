...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*WorkloadIdentity)(nil), (*config.WorkloadIdentity)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_WorkloadIdentity_To_config_WorkloadIdentity(a.(*WorkloadIdentity), b.(*config.WorkloadIdentity), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.WorkloadIdentity)(nil), (*WorkloadIdentity)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_WorkloadIdentity_To_v1alpha1_WorkloadIdentity(a.(*config.WorkloadIdentity), b.(*WorkloadIdentity), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha1_ControllerConfiguration_To_config_ControllerConfiguration(in *ControllerConfiguration, out *config.ControllerConfiguration, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_WorkloadIdentity_To_config_WorkloadIdentity(&in.WorkloadIdentity, &out.WorkloadIdentity, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_config_ControllerConfiguration_To_v1alpha1_ControllerConfiguration(in *config.ControllerConfiguration, out *ControllerConfiguration, s conversion.Scope) error {
	...
	out.HealthCheckConfig = (*apisconfigv1alpha1.HealthCheckConfig)(unsafe.Pointer(in.HealthCheckConfig))
	out.FeatureGates = *(*map[string]bool)(unsafe.Pointer(&in.FeatureGates))
	if err := Convert_config_WorkloadIdentity_To_v1alpha1_WorkloadIdentity(&in.WorkloadIdentity, &out.WorkloadIdentity, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha1_WorkloadIdentity_To_config_WorkloadIdentity(in *WorkloadIdentity, out *config.WorkloadIdentity, s conversion.Scope) error {
...
// Convert_v1alpha1_WorkloadIdentity_To_config_WorkloadIdentity is an autogenerated conversion function.
func Convert_v1alpha1_WorkloadIdentity_To_config_WorkloadIdentity(in *WorkloadIdentity, out *config.WorkloadIdentity, s conversion.Scope) error {
	return autoConvert_v1alpha1_WorkloadIdentity_To_config_WorkloadIdentity(in, out, s)
}

func autoConvert_config_WorkloadIdentity_To_v1alpha1_WorkloadIdentity(in *config.WorkloadIdentity, out *WorkloadIdentity, s conversion.Scope) error {
	out.AllowedTokenURLs = *(*[]string)(unsafe.Pointer(&in.AllowedTokenURLs))
	out.AllowedServiceAccountImpersonationURLRegExps = *(*[]string)(unsafe.Pointer(&in.AllowedServiceAccountImpersonationURLRegExps))
	return nil
}

// Convert_config_WorkloadIdentity_To_v1alpha1_WorkloadIdentity is an autogenerated conversion function.
func Convert_config_WorkloadIdentity_To_v1alpha1_WorkloadIdentity(in *config.WorkloadIdentity, out *WorkloadIdentity, s conversion.Scope) error {
	return autoConvert_config_WorkloadIdentity_To_v1alpha1_WorkloadIdentity(in, out, s)
}

...
func (in *BackupBucket) DeepCopyInto(out *BackupBucket) {
	*out = *in
	if in.AllowedEndpointOverrideURLs != nil {
		in, out := &in.AllowedEndpointOverrideURLs, &out.AllowedEndpointOverrideURLs
...
func (in *WorkloadIdentity) DeepCopyInto(out *WorkloadIdentity) {
	*out = *in
	if in.AllowedTokenURLs != nil {
		in, out := &in.AllowedTokenURLs, &out.AllowedTokenURLs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.AllowedServiceAccountImpersonationURLRegExps != nil {
		in, out := &in.AllowedServiceAccountImpersonationURLRegExps, &out.AllowedServiceAccountImpersonationURLRegExps
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return

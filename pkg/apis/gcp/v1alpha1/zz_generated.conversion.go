...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*CapabilitySet)(nil), (*gcp.CapabilitySet)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CapabilitySet_To_gcp_CapabilitySet(a.(*CapabilitySet), b.(*gcp.CapabilitySet), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*gcp.CapabilitySet)(nil), (*CapabilitySet)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_gcp_CapabilitySet_To_v1alpha1_CapabilitySet(a.(*gcp.CapabilitySet), b.(*CapabilitySet), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_CapabilitySet_To_gcp_CapabilitySet(in *CapabilitySet, out *gcp.CapabilitySet, s conversion.Scope) error {
	out.Capabilities = *(*core.Capabilities)(unsafe.Pointer(&in.Capabilities))
	out.Image = in.Image
	return nil
}

// Convert_v1alpha1_CapabilitySet_To_gcp_CapabilitySet is an autogenerated conversion function.
func Convert_v1alpha1_CapabilitySet_To_gcp_CapabilitySet(in *CapabilitySet, out *gcp.CapabilitySet, s conversion.Scope) error {
	return autoConvert_v1alpha1_CapabilitySet_To_gcp_CapabilitySet(in, out, s)
}

func autoConvert_gcp_CapabilitySet_To_v1alpha1_CapabilitySet(in *gcp.CapabilitySet, out *CapabilitySet, s conversion.Scope) error {
	out.Capabilities = *(*core.Capabilities)(unsafe.Pointer(&in.Capabilities))
	out.Image = in.Image
	return nil
}

// Convert_gcp_CapabilitySet_To_v1alpha1_CapabilitySet is an autogenerated conversion function.
func Convert_gcp_CapabilitySet_To_v1alpha1_CapabilitySet(in *gcp.CapabilitySet, out *CapabilitySet, s conversion.Scope) error {
	return autoConvert_gcp_CapabilitySet_To_v1alpha1_CapabilitySet(in, out, s)
}
...
func autoConvert_v1alpha1_MachineImageVersion_To_gcp_MachineImageVersion(in *MachineImageVersion, out *gcp.MachineImageVersion, s conversion.Scope) error {
	...
	out.Image = in.Image
	out.Architecture = (*string)(unsafe.Pointer(in.Architecture))
	out.CapabilitySets = *(*[]gcp.CapabilitySet)(unsafe.Pointer(&in.CapabilitySets))
	return nil
}

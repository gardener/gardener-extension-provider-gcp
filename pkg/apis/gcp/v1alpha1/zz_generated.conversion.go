...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*SubnetReference)(nil), (*gcp.SubnetReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_SubnetReference_To_gcp_SubnetReference(a.(*SubnetReference), b.(*gcp.SubnetReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*gcp.SubnetReference)(nil), (*SubnetReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_gcp_SubnetReference_To_v1alpha1_SubnetReference(a.(*gcp.SubnetReference), b.(*SubnetReference), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_NetworkConfig_To_gcp_NetworkConfig(in *NetworkConfig, out *gcp.NetworkConfig, s conversion.Scope) error {
	...
	out.SubnetWorkers = (*gcp.SubnetReference)(unsafe.Pointer(in.SubnetWorkers))
	out.SubnetServices = (*gcp.SubnetReference)(unsafe.Pointer(in.SubnetServices))
	return nil
}
...
func autoConvert_gcp_NetworkConfig_To_v1alpha1_NetworkConfig(in *gcp.NetworkConfig, out *NetworkConfig, s conversion.Scope) error {
	...
	out.MTU = (*int32)(unsafe.Pointer(in.MTU))
	out.SubnetWorkers = (*SubnetReference)(unsafe.Pointer(in.SubnetWorkers))
	out.SubnetServices = (*SubnetReference)(unsafe.Pointer(in.SubnetServices))
	return nil
}
...
func autoConvert_v1alpha1_SubnetReference_To_gcp_SubnetReference(in *SubnetReference, out *gcp.SubnetReference, s conversion.Scope) error {
	out.Name = in.Name
	out.PodSecondaryRangeName = (*string)(unsafe.Pointer(in.PodSecondaryRangeName))
	return nil
}

// Convert_v1alpha1_SubnetReference_To_gcp_SubnetReference is an autogenerated conversion function.
func Convert_v1alpha1_SubnetReference_To_gcp_SubnetReference(in *SubnetReference, out *gcp.SubnetReference, s conversion.Scope) error {
	return autoConvert_v1alpha1_SubnetReference_To_gcp_SubnetReference(in, out, s)
}

func autoConvert_gcp_SubnetReference_To_v1alpha1_SubnetReference(in *gcp.SubnetReference, out *SubnetReference, s conversion.Scope) error {
	out.Name = in.Name
	out.PodSecondaryRangeName = (*string)(unsafe.Pointer(in.PodSecondaryRangeName))
	return nil
}

// Convert_gcp_SubnetReference_To_v1alpha1_SubnetReference is an autogenerated conversion function.
func Convert_gcp_SubnetReference_To_v1alpha1_SubnetReference(in *gcp.SubnetReference, out *SubnetReference, s conversion.Scope) error {
	return autoConvert_gcp_SubnetReference_To_v1alpha1_SubnetReference(in, out, s)
}
